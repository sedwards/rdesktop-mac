...
our %config = (
    ...
    "perlargv" => [
        "no-shared",
        "no-tests",
        "--prefix=/Users/sedwards/source/rdesktop-mac/deps/openssl_build"
    ],
    "perlenv" => {
        "AR" => undef,
        "ARFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/Users/sedwards/source/rdesktop-mac/deps/openssl-3.0.15/util/perl';
    use OpenSSL::fallback '/Users/sedwards/source/rdesktop-mac/deps/openssl-3.0.15/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/sedwards/source/rdesktop-mac/deps/openssl-3.0.15/Configurations';
        use gentemplate;
