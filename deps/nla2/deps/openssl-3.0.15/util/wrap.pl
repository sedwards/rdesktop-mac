...
BEGIN {
    ...
    require '/Users/sedwards/source/rdesktop-mac/deps/nla2/deps/openssl-3.0.15/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/sedwards/source/rdesktop-mac/deps/nla2/deps/openssl-3.0.15/test/fips-and-base.cnf';
    shift;
